...
model = create_model('fastvit_s12', num_classes=10)
model.to(device)
...
output_dir = '/home/tbaweja/811/checkpoints'
...
for epoch in tqdm(range(epochs)):
    ...
    with torch.no_grad():
        ...
        logfile2 = open("ValidationLogs.txt", "w")
...
print("Total Train Time to run 100 epocs: ", sum(total_train_time)/ len(total_train_time))